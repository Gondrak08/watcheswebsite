        ...
        <section id='offers-display' className='w-full h-full'>
            <div className='container h-full py-8 mx-auto flex flex-col gap-10 justify-center'>
                <div className='texts mx-auto py-3 max-w-[658px] w-full h-[fit-content] text-center'>
                    <h3 className='text-[45px]  text-wbrown uppercase'>best delicious offers</h3>
                    <span className='font-jost text-[20px] text-wwhite opacity-[0.7] max-w-[258px] w-full' >In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual.</span>
                </div>
