                    ...
                    <div className="col-4 text-wwhite flex flex-col gap-3">
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='relative  h-[3.5em]' >
                                <input type="text" placeholder='Your Email' className='p-4 w-full h-full bg-black border border-[1px] border-white rounded-3xl font-poppins placeholder:text-wwhite ' />
